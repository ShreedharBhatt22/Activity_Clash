...
while ($row =mysqli_fetch_assoc($result)) {
  $e=$row['e_id'];
      ...
      <tr>
        ...
        <td><a href="addevents.php?id=<?php echo $row['e_id'] ?>">Add</a>|<a href="editevents.php?id=<?php echo $row['e_id'] ?>">Edit</a>|<a href="delevents.php?id=<?php echo $row['e_id'] ?>">Delete</a></td>
      </tr>
<?php } } ?>
